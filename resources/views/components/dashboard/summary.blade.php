            ...
            <div class="card card-plain h-100 bg-white">
                <div class="p-3">
                    <div class="row">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 d-flex align-items-center justify-content-center">
                            <div class="icon icon-shape bg-gradient-primary shadow border-radius-md text-center">
                                <i class="fas fa-box fa-2x w-100"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-plain h-100 bg-white">
                <div class="p-3">
                    <div class="row">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 d-flex align-items-center justify-content-center">
                            <div class="icon icon-shape bg-gradient-primary shadow border-radius-md text-center">
                                <i class="fas fa-tag fa-2x w-100"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-plain h-100 bg-white">
                <div class="p-3">
                    <div class="row">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 d-flex align-items-center justify-content-center">
                            <div class="icon icon-shape bg-gradient-primary shadow border-radius-md text-center">
                                <i class="fas fa-user fa-2x w-100"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-plain h-100  bg-white">
                <div class="p-3">
                    <div class="row">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 d-flex align-items-center justify-content-center">
                            <div class="icon icon-shape bg-gradient-primary shadow border-radius-md text-center">
                                <i class="fas fa-file-invoice fa-2x w-100"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-plain h-100 bg-white">
                <div class="p-3">
                    <div class="row">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 d-flex align-items-center justify-content-center">
                            <div class="icon icon-shape bg-gradient-primary shadow border-radius-md text-center">
                                <i class="fas fa-chart-line fa-2x w-100"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-plain h-100  bg-white">
                <div class="p-3">
                    <div class="row">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 d-flex align-items-center justify-content-center">
                            <div class="icon icon-shape bg-gradient-primary shadow border-radius-md text-center">
                                <i class="fas fa-percent fa-2x w-100"></i>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card card-plain h-100  bg-white">
                <div class="p-3">
                    <div class="row">
                        ...
                        <div class="col-3 col-lg-4 col-md-4 col-sm-3 d-flex align-items-center justify-content-center">
                            <div class="icon icon-shape bg-gradient-primary shadow border-radius-md text-center">
                                <i class="fas fa-wallet fa-2x w-100"></i>
                            </div>
                        </div>
                    </div>
                </div>
